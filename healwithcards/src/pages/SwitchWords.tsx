...
const slides =  [
    {heading: 'Harness the Power of Switch-Words for Instant Change', subHeading: 'Top Switch-Words for Love, Money & Health'},
    {heading: 'How Switch-Words Can Shift Your Energy Fast', subHeading: 'How to Use Switch-Words in Your Daily Life'},
    {heading: 'Switch-Words: The Secret to Manifestation', subHeading: 'Combining Switch-Words with Tarot for Deeper Insight'},
]
...
const SwitchWords = () => {
  return (
   <PerPageComponent services={services} slides={slides} name={'Switch Words'}/>
  )
}
