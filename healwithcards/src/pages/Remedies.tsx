...
const slides = [
  {
    heading: "Balance Your Mind, Body & Spirit with Remedies",
    subHeading: "Remedies to Remove Negative Energy",
  },
  {
    heading: "Healing Remedies from the Tarot and Beyond",
    subHeading: "Tarot-Based Remedies for Love & Career",
  },
  {
    heading: "Spiritual Remedies for Everyday Challenges",
    subHeading: "Simple Healing Practices You Can Do at Home",
  },
];
