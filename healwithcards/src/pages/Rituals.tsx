...
const slides = [
  {
    heading: "Elevate Your Energy with Daily Spiritual Rituals",
    subHeading: "Ritual Tools & Their Magical Meanings",
  },
  {
    heading: "Ancient Rituals for Modern Souls",
    subHeading: "How to Create Your Own Personalized Ritual",
  },
  {
    heading: "Powerful Rituals to Transform Your Life",
    subHeading: "Simple Rituals for Protection & Prosperity",
  },
];
